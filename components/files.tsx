...
const downloads = [
  {
    name: "ObserverGame",
    description: "The SourceCode and Content Files",
    buttontext: "Download",
  },
  {
    name: "none1",
...
function BorderBeam() {
  return (
    <div className="absolute inset-0 rounded-2xl overflow-hidden pointer-events-none">
      <div
        className="absolute w-4 h-4 bg-white/60 blur-xl border-beam"
        style={{
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto mb-8">
            Projekte und Skripts zum runterladen.
          </p>
        ...
        >
          {downloads.map((downloads, index) => (
            ...
            >
              ...
              <div className="mb-6">
                <h3 className="text-xl font-semibold text-white mb-2">{downloads.name}</h3>
                <p className="text-zinc-400 text-sm">{downloads.description}</p>
              </div>

              <Button className="w-full rounded-full bg-zinc-800 text-white hover:bg-zinc-700 border border-zinc-700">
                {downloads.buttontext}
              </Button>
            </motion.div>
          ))}
        </motion.div>
