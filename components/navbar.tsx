      ...
      >
        ...
        <a href="#" className="flex items-center gap-2">
          ...
          <div className="w-8 h-8 rounded-lg bg-white flex items-center justify-center">
            <span className="text-zinc-950 font-bold text-sm material-icons">search</span>
          </div>
          */}
          ...
          <div className="flex items-center gap-2 text-zinc-400">
            <div className="w-8 h-8 rounded-lg bg-zinc-800 flex items-center justify-center">
              <span className="text-xs font-bold">ValeArt</span>
            </div>
          </div>
          */}

          <span className="text-[32px] font-medium" style={{ fontFamily: "var(--font-montserrat)" }}>ValeArt</span>
        </a>
