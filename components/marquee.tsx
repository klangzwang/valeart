...
const logos = [
  { name: "BoolModelling", width: 100 },
  { name: "Locomotions", width: 80 },
  { name: "SlateCoding", width: 90 },
  { name: "MinecraftMods", width: 100 },
  { name: "PBRTextures", width: 70 },
  { name: "UIScripting", width: 90 },
  { name: "NormalMapping", width: 100 },
  { name: "PhysicsColl", width: 90 },
]
...
export function Marquee() {
  ...
  return (
    <section ref={ref} className="py-16 overflow-hidden">
      ...
      >
        <p className="text-sm text-zinc-500 uppercase tracking-wider font-medium">Mit welchen Techniken ich arbeite</p>
      </motion.div>
